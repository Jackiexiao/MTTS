...
class LabGenerator(object):
    ...
    def b(self):
        ...
        if father:
            ...
            order=sum(len(son.txt) for son in ggfather.sons[0:gfather.index-1])+father.index
            self.dict[Lab.b][4]=str(order)
            self.dict[Lab.b][5]=str(total-order+1)
            # 韵律短语层
            gggfather=ggfather.father
            total=len(gggfather.txt)
            order=sum(len(son.txt) for son in gggfather.sons[0:ggfather.index-1])+order
            ...
            self.dict[Lab.b][1]=str(len(gggfather.father.father.txt)-left-1)
    ...
    def c(self):
        ...
        if father:
            ...
            self.dict[Lab.c][4]=str(len(gfather.txt))
            if gfather.lbrother:
                self.dict[Lab.c][0]=gfather.lbrother.pos
                self.dict[Lab.c][3]=str(len(gfather.lbrother.txt))
            if gfather.rbrother:
                self.dict[Lab.c][2]=gfather.rbrother.pos
                self.dict[Lab.c][5]=str(len(gfather.rbrother.txt))
    ...
    def d(self):
        ...
        if father:
            ...
            self.dict[Lab.d][1]=str(len(gfather.txt))
            if gfather.lbrother:
                self.dict[Lab.d][0]=str(len(gfather.lbrother.txt))
            if gfather.rbrother:
                self.dict[Lab.d][2]=str(len(gfather.rbrother.txt))
    ...
    def e(self):
        ...
        if father:
            ...
            self.dict[Lab.e][1]=str(len(gfather.txt))
            self.dict[Lab.e][4]=str(gfather.sons_num)
            if gfather.lbrother:
                self.dict[Lab.e][0]=str(len(gfather.lbrother.txt))
                self.dict[Lab.e][3]=str(gfather.lbrother.sons_num)
            if gfather.rbrother:
                self.dict[Lab.e][2]=str(len(gfather.rbrother.txt))
    ...
    def f(self):
        ...
        if father:
            ...
            #self.dict[Lab.f][1]=str(len(gfather.txt))
            self.dict[Lab.f][1]=str(len(gfather.txt))
